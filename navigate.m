...
while true        
    ...
    [localT, localpath, localpath_vel, localpath_acc] = plan_trajectory(params.planner, cons_binmap, local_start, local_goal, mav.velocity, local_goal_vel, mav.acceleration);
    %%    
