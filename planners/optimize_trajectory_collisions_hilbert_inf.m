function [trajectory_out, iterations, final_cost, initial_cost] = optimize_trajectory_collisions_hilbert_inf(map, trajectory, visualize, random_perturb, random_perturb_mag, localmap, hilbertmap, param)
...
[initial_cost, initial_grad] = get_trajectory_cost_hilbert_inf(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds, localmap, hilbertmap, param);

%%
cost_func = @(x0)get_trajectory_cost_hilbert_inf(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds, localmap, hilbertmap, param);
tic
