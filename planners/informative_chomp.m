function [trajectory] = informative_chomp(map, initpos, finalpos, initvel, finalvel, initacc, hilbertmap)
...
trajectory = optimize_trajectory_collisions_inf(map, trajectory, 0, hilbertmap);
