...
trajectory_hybrid = optimize_trajectory_collisions_hybrid(map, trajectory, 0, 0, 0.1, occupancymap.localmap, hilbertmap, param);
...
[t, p1] = sample_trajectory(trajectory_hybrid, 0.1);
