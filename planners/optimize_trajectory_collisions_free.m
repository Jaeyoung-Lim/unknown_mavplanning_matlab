function [trajectory_out, iterations, final_cost, initial_cost] = optimize_trajectory_collisions_free(map, trajectory, visualize, random_perturb, random_perturb_mag)
...
[initial_cost, initial_grad] = get_trajectory_cost_free(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds);

%%
cost_func = @(x0)get_trajectory_cost_free(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds);
tic
