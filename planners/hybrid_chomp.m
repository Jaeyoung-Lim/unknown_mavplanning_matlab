function [trajectory] = hybrid_chomp(param, map, initpos, finalpos, initvel, finalvel, initacc, localmap, hilbertmap)
...
trajectory = optimize_trajectory_collisions_hybrid(map, trajectory, 0, 0, 0.1, localmap, hilbertmap, param, finalpos);
