...
trajectory = add_vertex_to_trajectory(trajectory, (3*start_point+1*goal_point)/4, 0, 1);
trajectory = add_vertex_to_trajectory(trajectory, (2*start_point+2*goal_point)/4, 0, 1);
trajectory = add_vertex_to_trajectory(trajectory, (1*start_point+3*goal_point)/4, 0, 1);
...
trajectory = optimize_trajectory_collisions_free(map, trajectory, 0);
%% Plot
figure(1);
