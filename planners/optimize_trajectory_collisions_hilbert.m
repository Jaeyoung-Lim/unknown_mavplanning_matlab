...
[initial_cost, initial_grad] = get_trajectory_cost_hilbert(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds, localmap, hilbertmap, param);

%%
cost_func = @(x0)get_trajectory_cost_hilbert(x0, trajectory, map,  cost_map, cost_map_x, cost_map_y, Ms, D_Fs, A_invs, R_unordereds, localmap, hilbertmap, param);
tic
